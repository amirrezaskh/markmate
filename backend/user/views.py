...
from course.serializers import CourseSerializer, AssignmentSerializer, SubmissionSerializer, AutoSubmissionSerializer
    ...
    def get_course_ids(self, user):
        ...
        if user.role == "student":
            ...
            course_ids = Course.objects.filter(
                instructor=user).values_list('id', flat=True)
        else:
